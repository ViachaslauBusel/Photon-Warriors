...
namespace Quantum.Prototypes {
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.DamageDealer))]
  public unsafe partial class DamageDealerPrototype : ComponentPrototype<Quantum.DamageDealer> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.DamageDealer result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.DamageDealer component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.DamageDealer result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.EnemySpawnerConfig))]
  public unsafe partial class EnemySpawnerConfigPrototype : ComponentPrototype<Quantum.EnemySpawnerConfig> {
    public Int32 MaxEnemies;
    public FP ArenaSize;
    [DynamicCollectionAttribute()]
    public AssetRef<EntityPrototype>[] EnemyPrototypes = {};
    partial void MaterializeUser(Frame frame, ref Quantum.EnemySpawnerConfig result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.EnemySpawnerConfig component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.EnemySpawnerConfig result, in PrototypeMaterializationContext context = default) {
        result.MaxEnemies = this.MaxEnemies;
        result.ArenaSize = this.ArenaSize;
        if (this.EnemyPrototypes.Length == 0) {
          result.EnemyPrototypes = default;
        } else {
          var list = frame.AllocateList(out result.EnemyPrototypes, this.EnemyPrototypes.Length);
          for (int i = 0; i < this.EnemyPrototypes.Length; ++i) {
            AssetRef<EntityPrototype> tmp = default;
            tmp = this.EnemyPrototypes[i];
            list.Add(tmp);
          }
        }
        MaterializeUser(frame, ref result, in context);
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.PlayerKillsHolder))]
  public unsafe partial class PlayerKillsHolderPrototype : ComponentPrototype<Quantum.PlayerKillsHolder> {
    public Int32 KillsCouner;
    partial void MaterializeUser(Frame frame, ref Quantum.PlayerKillsHolder result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.PlayerKillsHolder component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.PlayerKillsHolder result, in PrototypeMaterializationContext context = default) {
        result.KillsCouner = this.KillsCouner;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  public unsafe partial class PlayerStatsPrototype : ComponentPrototype<Quantum.PlayerStats> {
    public AssetRef<PlayerStatUpgraders> Upgraders;
    ...
    public void Materialize(Frame frame, ref Quantum.PlayerStats result, in PrototypeMaterializationContext context = default) {
        result.Upgraders = this.Upgraders;
        MaterializeUser(frame, ref result, in context);
    }
  }
}
