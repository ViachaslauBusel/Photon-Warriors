...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct DamageDealer : Quantum.IComponent {
    public const Int32 SIZE = 4;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    private fixed Byte _alignment_padding_[4];
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (DamageDealer*)ptr;
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct EnemySpawnerConfig : Quantum.IComponent {
    public const Int32 SIZE = 24;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    ...
    public FP ArenaSize;
    [FieldOffset(8)]
    public QListPtr<AssetRef<EntityPrototype>> EnemyPrototypes;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 17707;
        hash = hash * 31 + MaxEnemies.GetHashCode();
        hash = hash * 31 + ArenaSize.GetHashCode();
        hash = hash * 31 + EnemyPrototypes.GetHashCode();
        return hash;
      }
    }
    public void ClearPointers(FrameBase f, EntityRef entity) {
      EnemyPrototypes = default;
    }
    public static void OnRemoved(FrameBase frame, EntityRef entity, void* ptr) {
      var p = (Quantum.EnemySpawnerConfig*)ptr;
      p->ClearPointers((Frame)frame, entity);
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (EnemySpawnerConfig*)ptr;
        serializer.Stream.Serialize(&p->MaxEnemies);
        QList.Serialize(&p->EnemyPrototypes, serializer, Statics.SerializeAssetRef);
        FP.Serialize(&p->ArenaSize, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct PlayerKillsHolder : Quantum.IComponent {
    public const Int32 SIZE = 4;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 13499;
        hash = hash * 31 + KillsCouner.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (PlayerKillsHolder*)ptr;
        serializer.Stream.Serialize(&p->KillsCouner);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial struct PlayerStats : Quantum.IComponent {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 14797;
        hash = hash * 31 + Upgraders.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        AssetRef.Serialize(&p->Upgraders, serializer);
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.DamageDealer>();
      BuildSignalsArrayOnComponentRemoved<Quantum.DamageDealer>();
      BuildSignalsArrayOnComponentAdded<Quantum.EnemySpawnerConfig>();
      BuildSignalsArrayOnComponentRemoved<Quantum.EnemySpawnerConfig>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.PlayerKillsHolder>();
      BuildSignalsArrayOnComponentRemoved<Quantum.PlayerKillsHolder>();
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.DamageDealer), Quantum.DamageDealer.SIZE);
      typeRegistry.Register(typeof(DistanceJoint), DistanceJoint.SIZE);
      typeRegistry.Register(typeof(DistanceJoint3D), DistanceJoint3D.SIZE);
      typeRegistry.Register(typeof(Quantum.EnemySpawnerConfig), Quantum.EnemySpawnerConfig.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.PlayerKillsHolder), Quantum.PlayerKillsHolder.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 11)
        ...
        .Add<Quantum.DamageDealer>(Quantum.DamageDealer.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.EnemySpawnerConfig>(Quantum.EnemySpawnerConfig.Serialize, null, Quantum.EnemySpawnerConfig.OnRemoved, ComponentFlags.None)
        .Add<Quantum.EntityHealth>(Quantum.EntityHealth.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerKillsHolder>(Quantum.PlayerKillsHolder.Serialize, null, null, ComponentFlags.None)
